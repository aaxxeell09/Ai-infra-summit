...
class ServerHarness(unittest.TestCase):
    ...
    def call(self, args):
        ...
        params = {"name": "local_feedback_diagnostic", "arguments": args}
    ...
    def test_builds_bounded_argv_and_preserves_verification(self):
        ...
        out_dir = Path(argv[argv.index("--output") + 1])
        self.assertTrue(str(out_dir).startswith(str(self.out_root)))
    ...
    def test_wire_protocol_framing(self):
        ...
        self.assertTrue(out[2]["result"]["structuredContent"]["isError"])
