...
The coding agent owns workstreams 1 and 2, integrates code, runs checks, maintains the research trail and pushes small working commits. Human collaborators own workstream 3, with UI and deck artifacts supplied by the agent. Human review focuses on three questions: are measurements real, are actions correct, and does the demo make the result clear?
